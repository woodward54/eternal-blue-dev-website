...
// export const projectsOldSlider = props('current', 'total', 'all')
// export const projectsSlider = props('currentProjects', 'totalProjects', 'allProjects')
export const skillsSlider = props('currentSkills', 'totalSkills', 'allSkills')
